...
#------------------------------------------------------------------------------
# 腳本：FS_EquipHelpScroll v1.2｜REFERENCE
# 【用途】Forest Symphony 專用 Runtime／資料腳本「FS_EquipHelpScroll v1.2｜REFERENCE」。
...
# 【設定／可調參數】優先調整本頁明確的設定常數／設定區，例如：SCROLL_SPEED、SCROLL_REFRESH_RATE、SCROLL_INITIAL_WAIT、LEFT_PADDING、RIGHT_PADDING。核心方法除非已確認依賴鏈，不建議直接覆寫。
...
$imported["FS Equip Help Scroll"] = "1.2"

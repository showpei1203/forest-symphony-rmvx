...
#------------------------------------------------------------------------------
# 腳本：特殊効果判定用ベーススクリプトＡVer1.11
# 【用途】保留的 Runtime 元件「特殊効果判定用ベーススクリプトＡVer1.11」。
# 【主要機制】主要定義／擴充 BaseItem、Actor、Class、Troop；下方原始說明與程式碼保留作細節依據。
# 【主要影響】BaseItem、Actor、Class、Troop、Enemy、State、Game_Battler
# 【設定／可調參數】本頁若沒有獨立 Configuration 區，表示主要行為由程式流程／資料庫／事件或其他 Authority 控制；不要只因名稱直覺修改核心方法。
# 【依賴／載入順序】含 8 個 alias／方法包裝，載入順序具有語意。
